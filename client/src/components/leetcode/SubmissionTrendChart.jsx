...
function SubmissionTrendChart({ weeklyProgress, loading }) {
  ...
  return (
    <ChartCard title="Weekly Progress" subtitle="Problems solved per week">
      <div className="h-[240px]" role="img" aria-label="Weekly progress area chart">
        {chartData.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
              <defs>
                <linearGradient id="lcTrendGrad" x1="0" y1="0" x2="0" y2="1">
              ...
              <Area type="monotone" dataKey="solved" name="Solved" stroke="#3B82F6" fill="url(#lcTrendGrad)" strokeWidth={2} dot={{ fill: '#3B82F6', r: 3 }} activeDot={{ r: 5 }} animationDuration={800} />
            </AreaChart>
          </ResponsiveContainer>
        ) : (
...
export default React.memo(SubmissionTrendChart);
