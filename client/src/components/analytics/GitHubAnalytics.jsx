  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">GitHub Analytics</h2>
      </div>
        ...
        <ChartCard title="Language Usage" subtitle="Distribution across languages">
          <div className="h-[220px] flex items-center">
            {langData.length > 0 ? (
              ...
              <p className="text-sm text-slate-400 dark:text-slate-500 text-center w-full">No language data</p>
            )}
          </div>
        </ChartCard>
