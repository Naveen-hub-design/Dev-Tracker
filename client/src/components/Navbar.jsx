        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            <NavLink to="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-slate-900 dark:text-slate-100">DevTrack</span>
            </NavLink>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 ml-2"
              >
              ...
              {showDropdown && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 shadow-lg z-20 py-1">
                    <button
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap transition-colors ${
                  isActive ? 'text-blue-600 bg-blue-50 dark:bg-blue-500/10' : 'text-slate-500 dark:text-slate-400'
                }`
              }
            >
